...
static void recv_callback(const char *topic, size_t topic_len, const void *payload, size_t payload_len, void *data) {
    printf("[%s] Received %zu bytes, %.*s\n", topic, payload_len, (int)payload_len, (char *)payload);
