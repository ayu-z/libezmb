...
gcc -o e_serial e_serial.c e_serialport.c e_config.c e_serial_manager.c e_queue.c -L . -lezmb -lpthread -ljson-c
# gcc -o e_config e_config.c e_queue.c -lpthread -ljson-c
gcc -o e_serial_coll e_serial_coll.c  e_serialport.c e_config.c e_serial_manager.c e_queue.c -lpthread -ljson-c -L . -lezmb 